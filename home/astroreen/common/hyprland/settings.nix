_: {
  ...
  window_rule = [
    ...
    # LocalSend 1.18 changed its Wayland app_id from `localsend_app` to
    # `org.localsend.localsend_app`; match both so the rule survives the rename.
    {
